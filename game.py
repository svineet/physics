...
class PhysicsGame(Widget):
    ...
    def __init__(self, **kwargs):
        ...
        self.toolbox.current_tool = self.tools["rectangle"]
    ...
    def on_touch_down(self, touch):
        self.toolbox.current_tool.on_touch_down(touch)

    def on_touch_up(self, touch):
        self.toolbox.current_tool.on_touch_up(touch)

    def on_touch_move(self, touch):
        self.toolbox.current_tool.on_touch_move(touch)

    def set_current_tool(tool_name):
        self.toolbox.current_tool = self.tools[tool_name]
